...
from .decoder_blocks import SEXceptionDecoderBlock, XceptionDecoderBlock, SimpleDecoderBlock
...
class SimpleXUnet(XUnet):
    def __init__(self, encoder, sample_input, n_categories, encoder_features_method=None,
        ...
        super().__init__(encoder=encoder, decoder_block_class=SimpleDecoderBlock,
                         downsampler_block_class=SimpleDownsamplerBlock,
                         output_block_class=SimpleOutputBlock, sample_input=sample_input,
...
class XceptionXUnet(XUnet):
    def __init__(self, encoder, sample_input, n_categories, encoder_features_method=None,
                 shared_decoders=False, reversed_features=True, activation='sigmoid'):
        """A XUnet with decoders, outputs and downsamplers Xception blocks
        ...
        super().__init__(encoder=encoder, decoder_block_class=XceptionDecoderBlock,
                         downsampler_block_class=XceptionDownsamplerBlock,
                         output_block_class=XceptionOutputBlock, sample_input=sample_input,
                         n_categories=n_categories, encoder_features_method=encoder_features_method,
                         shared_decoders=shared_decoders, reversed_features=reversed_features,
                         activation=activation)
